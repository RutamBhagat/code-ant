                ...
                {navigationItems.map((item) => {
                  ...
                  return (
                    <Link
                      ...
                      href={item.url}
                      className={cn(
                        "flex items-center gap-3 rounded-md px-3 py-2.5 text-[15px] font-semibold text-gray-700 transition-colors hover:bg-[#1570ef] hover:text-white",
                        isActive && "bg-[#1570ef] text-white",
                      )}
                      onClick={() => setIsOpen(false)}
                    >
                  ...
                  {footerItems.map((item) =>
                    item.url ? (
                      <Link
                        key={item.title}
                        href={item.url}
                        className="flex items-center gap-3 rounded-md px-3 py-2.5 text-[15px] font-semibold text-gray-700 transition-colors hover:bg-[#1570ef] hover:text-white"
                        onClick={() => setIsOpen(false)}
                      >
                        <item.icon className="h-5 w-4" />
                        {item.title}
                      ...
                      <button
                        ...
                        className="text-md flex w-full items-center gap-3 rounded-md px-3 py-2.5 font-semibold text-gray-700 transition-colors hover:bg-[#1570ef] hover:text-white"
                      >
                        <item.icon className="h-5 w-4" />
                        {item.title}
                      </button>
